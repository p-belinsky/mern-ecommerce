    ...
    >
      <div className="container mx-auto px-4 py-3">
        ...
        <nav className="flex flex-wrap items-center gap-4">
          ...
          {isAdmin && (
            <Link className="bg-emerald-700 hover:bg-emerald-600 text-white py-1 px-3 rounded-md font-medium transition duration-300 ease-in-out flex items-center" to={"/secret-dashboard"}>
